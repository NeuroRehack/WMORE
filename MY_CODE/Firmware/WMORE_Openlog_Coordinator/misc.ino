...
/*******************************************/
void Serial1Print(const char *);
void Serial1Print(const __FlashStringHelper *);
void Serial1Println(const char *);
void Serial1Println(const __FlashStringHelper *);
void DoSerial1Print(char (*)(const char *), const char *, bool newLine = false);
...
******************************************
*/
void Serial1Print(const char *line)
{
  DoSerial1Print([](const char *ptr) {return *ptr;}, line);
}

void Serial1Print(const __FlashStringHelper *line)
{
  DoSerial1Print([](const char *ptr) {return (char) pgm_read_byte_near(ptr);}, (const char*) line);
}

void Serial1Println(const char *line)
{
  DoSerial1Print([](const char *ptr) {return *ptr;}, line, true);
}

void Serial1Println(const __FlashStringHelper *line)
{
  DoSerial1Print([](const char *ptr) {return (char) pgm_read_byte_near(ptr);}, (const char*) line, true);
}

void DoSerial1Print(char (*funct)(const char *), const char *string, bool newLine)
{
  char ch;
...
// general print statements for debugging purposes
void printStatements(const char *str, int val) {

   char strBuff[strlen(str)];
   sprintf(strBuff, "%s%d", str, val);
   Serial1Print(strBuff);
   Serial1Print(F(" "));
}