...
struct struct_settings {
  ...
  bool useTxRxPinsForTerminal = true; // Set to true by Nathan // If true, the terminal is echo'd to the Tx and Rx pins. Note: setting this to true will _permanently_ disable serial logging and analog input on those pins!
