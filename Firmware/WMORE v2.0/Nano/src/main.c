...
/*************************************************************************************
 * WMORE Arduino Nano 33 BLE Firmware
 * 25.11.25
 *
 * Overview:
 ...
 *
 * Notes:
 *   - The original firmware was written for the OLA + Seeed XIAO BLE.
 *   - This version targets the Arduino Nano 33 BLE. The only difference between the 
 *     two versions is the line #define NANO, and the name of the board (overlay) file.
